...
func (server *Server) LoginUser(ctx context.Context, req *pb.LoginUserRequest) (*pb.LoginUserResponse, error) {
	...
	if err != nil {
		return nil, status.Errorf(codes.Internal, "create to failed acceess token: %s", err)
	}
	...
	if err != nil {
		return nil, status.Errorf(codes.Internal, "create to failed refresh token: %s", err)
	}
