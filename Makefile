...
postgres_container:
	docker run --name postgres12 --network bank-network -p 5432:5432 -e POSTGRES_USER=root -e POSTGRES_HOST_AUTH_METHOD=trust -e POSTGRES_PASSWORD=hide1337 -d postgres:12-alpine
